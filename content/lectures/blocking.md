...
Более того, часто в описании системных вызовов преведены примеры на C.
...
Если заменить TCP сокета на UDP, то программа успешно запускается и "зависает".
...
[Функция listen][listen3] позволяет перевести сокет в "слушающий режим" (такой сокета называется пассивным).
