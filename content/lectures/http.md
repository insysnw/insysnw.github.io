...
А ещё в версии **0.9** говорилось, что для HTTP в целом подойдёт любой сессионный протокол, не обязательно TCP.
Настало время пробовать что-то помимо TCP!
Проблема с чем-то помимо TCP лишь в том, что других поддерживаемых во всём мире сессионным протоколов транспортного уровня нет.
...
Так в недрах Google появился протокол **QUIC**, что когда-то было аббривиатурой от *Quick UDP Internet Connections*, но более таковой не является.
Аббревиатура подчёркивала игрой слов (QUIC читается как "quick") основную особенность, протокол должен быть быстрее.
Добивается он этого в том числе решением двух, упомянутых ранее, проблем.
...
Дополнительный бонус наличия сессии над транспортным уровнем — смену IP адреса клиента можно обработать сохранив уже установленную сессию.
